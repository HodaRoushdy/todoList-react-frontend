...
const buttonVariants = cva(
  "rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed flex justify-center items-center gap-[0.5vw]",
  {
    variants: {
      variant: {
        // ** FILLED
        ...
        cancel:
          "bg-gray-300 text-gray-700 dark:bg-gray-400 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-300",
